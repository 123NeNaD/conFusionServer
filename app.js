...
//The secret string could be any string, so we are just going to supply a string "12345-67890-09876-54321". It doesn't have to be
...
function auth(req, res, next) {
    ...
    //If the incoming request does not include the "user" field in the "signed.Cookies", then that means that user has not been authorized yet. 
    //"user" will be a property that we will set up in the signed cookie. In that case we will expect the user to authenticate himself
    // by including the Authorization Header.
